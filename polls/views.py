...
from django.http import HttpResponse, HttpResponseRedirect # HttpResponse est uniquement utile pour les vues détails, résults et vote qui n'ont pas la fonction render()
